...
module_db: List[ModuleInfo] = [
    ...
    ModuleInfo(torch.nn.AvgPool2d,
               ...
               skips=(
                   ...
                   DecorateInfo(
                       ...
                       'TestModule',
                       'test_memory_format',
                       active_if=lambda p: p['training'] and p['device'] == 'cuda',
                   ),),
               ),
    ...
    ModuleInfo(torch.nn.BatchNorm2d,
               ...
               skips=(
                   ...
                   # native_batch_norm_backward on cuda does not support channels last.
                   # see https://github.com/pytorch/pytorch/issues/107199
                   DecorateInfo(
                       unittest.expectedFailure,
                       'TestModule',
                       'test_memory_format',
